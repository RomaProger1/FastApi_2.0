...
from modeles.good import Main_User, Main_UserDB, New_Respons
import hashlib
...
user_list = [Main_UserDB(name='Denisov', id=1, password='***********'),
             Main_UserDB(name='Ivanov', id=2, password='**********'),
             Main_UserDB(name='Pupin', id=3, password='**********')]
...
def get_users():
    '''
    Документация APIRouter, FastAPI и тд...
    '''
    return user_list
